        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="animate-slide-up">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              <Link to="/chat">
                <Button size="lg" className="bg-primary hover:bg-primary/90 text-black px-8 py-3 text-lg">
                  <Camera className="w-5 h-5 mr-2" />
                  Try It Free
                </Button>
              </Link>
              <Button variant="outline" size="lg" className="px-8 py-3 text-lg border-primary text-white hover:bg-primary hover:text-black" onClick={handleSeeHowItWorks}>
            ...
            <div className="features-preview grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto">
              <div className="bg-gray-900/80 backdrop-blur-sm p-6 rounded-2xl shadow-sm animate-scale-in border border-primary">
              ...
              <div className="bg-gray-900/80 backdrop-blur-sm p-6 rounded-2xl shadow-sm animate-scale-in border border-primary" style={{animationDelay: '0.1s'}}>
                <div className="w-12 h-12 bg-primary/10 rounded-xl flex items-center justify-center mb-4 mx-auto">
              ...
              <div className="bg-gray-900/80 backdrop-blur-sm p-6 rounded-2xl shadow-sm animate-scale-in border border-primary" style={{animationDelay: '0.2s'}}>
                <div className="w-12 h-12 bg-primary/10 rounded-xl flex items-center justify-center mb-4 mx-auto">
